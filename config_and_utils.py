...
#
#  Scope: Sagittal diseases only —
#           • Spinal Canal Stenosis    (Sagittal T2/STIR)
#           • Subarticular Stenosis    (Sagittal T1)
#
#  Axial / Foraminal Narrowing will be handled separately.
#
#  KEY CHANGE vs original: VolumeCache
#  ------------------------------------
#  All DICOM volumes are loaded ONCE, converted to float16, and
#  held in a dict keyed by (study_id, series_id).  Datasets and
#  helpers accept a `cache` argument instead of re-reading DICOMs.
#  The cache can also be persisted to / restored from a .npz file
#  on disk so a crashed run doesn't force a full re-read.
# ============================================================
